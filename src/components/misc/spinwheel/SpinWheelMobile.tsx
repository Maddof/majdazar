...
export function SpinWheelMobile({
  items,
  onResultChange,
}: {
  items?: string[];
  ...
  return (
    <div className="flex flex-col items-center gap-6 md:hidden">
      <p className="max-w-28 text-center text-[80%] font-medium tracking-wide uppercase">
        Drag or click to spin
      </p>
      <div className="relative inline-block">
        {/* Drag hint — top-left of wheel */}
        <div className="absolute -top-2 left-0 z-10 flex -translate-x-1/8 translate-y-1/6 flex-col items-end gap-1 opacity-60">
          ...
          <svg
            ...
            className="text-foreground -rotate-10"
          >
        ...
        <Button
          ...
          size="sm"
          className="border-secondary absolute top-1/2 left-1/2 size-12 -translate-x-1/2 -translate-y-1/2 rounded-full border text-[80%]"
        >
